...
st.markdown("""
    ...
    .stat-1 { background: linear-gradient(135deg, #2d6a4f, #52b788); }
    .stat-2 { background: linear-gradient(135deg, #1d4ed8, #60a5fa); }
    .stat-3 { background: linear-gradient(135deg, #b45309, #f59e0b); }
    .stat-4 { background: linear-gradient(135deg, #7c3aed, #c084fc); }
    ...
    div[data-testid="stFileUploaderDropzone"]:hover {
        ...
        background: linear-gradient(135deg, #eef4ff 0%, #e0ecff 100%) !important;
    }
    ...
    .chip-1 { background: linear-gradient(135deg, #b45309, #f59e0b); }
    .chip-2 { background: linear-gradient(135deg, #0e7490, #22d3ee); }
    .chip-3 { background: linear-gradient(135deg, #4d7c0f, #a3e635); }
    .chip-4 { background: linear-gradient(135deg, #7c3aed, #c084fc); }
    .step-card {
        color: white;
        border-radius: 16px;
    ...
    .step-1 { background: linear-gradient(160deg, #0f766e, #2dd4bf); }
    .step-2 { background: linear-gradient(160deg, #1e3a8a, #3b82f6); }
    .step-3 { background: linear-gradient(160deg, #9d174d, #f472b6); }
    .step-num {
